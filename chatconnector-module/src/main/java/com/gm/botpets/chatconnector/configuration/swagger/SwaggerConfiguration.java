package com.gm.botpets.chatconnector.configuration.swagger;
...
public class SwaggerConfiguration {
	...
	public  final String CONTROLLER_PACKAGE = "com.gm.botpets.chatconnector.admin.controller";
	public  final String APP_TITLE = "chatconnector";
